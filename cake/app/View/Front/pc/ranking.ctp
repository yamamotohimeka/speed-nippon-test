			...
			<div class="rank_outer">
				<div class="rank_tab">
					<ul class="flex">
						...
						<?php if (!empty($printArray['Ranking'][1][0]['Ranking']['title'])) { ?><li class="tab2"><?php echo $printArray['Ranking'][1][0]['Ranking']['title']; ?>ランキング</li><?php } ?>
						<?php if (!empty($printArray['Ranking'][2][0]['Ranking']['title'])) { ?><li class="tab3"><?php echo $printArray['Ranking'][2][0]['Ranking']['title']; ?>ランキング</li><?php } ?>
					</ul>
				</div>

                <!-- ランキングのステータスを持っている女の子を出す処理-->
				<div class="rank_wrap">
