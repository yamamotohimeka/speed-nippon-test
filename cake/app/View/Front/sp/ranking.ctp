                    ...
                    <section class="ranking-content swiper-slide">
                        ...
                        <div class="ranking-top">
                            <div class="ranking-top-inner">
                                ...
                                <?php if (!empty($printArray['Ranking'][$key2][0]['Image'][1]['Image']['imgId'])) { ?>
                                    <div class="ranking-top-image">
                                        <img src="/userImgShop/Image/<?php echo $printArray['Ranking'][$key2][0]['Image'][1]['Image']['imgId']; ?>/w565.jpg"
                                             class="ranking-top-image-main" alt=""/>
                                    </div>
                                <?php } ?>
                            </div>
                            <a href="/profile/<?php echo $printArray['Ranking'][$key2][0]['Girl']['id']; ?>"
                                ...
                                <?php foreach ($printArray['Ranking'][$key2] as $key => $value) { ?>
                                    <?php if ($key > 0) { ?>
                                        <li class="ranking-list-item">
                                            <h4 class="ranking-list-head">
                                                <?php
                                                $name = $value['Girl']['name'];
                                                if (mb_strlen($name) > 6) {
                                                    $name = mb_substr($name, 0, 6) . '...';
                                                }
                                                echo $name;
                                                ?> (<?php echo $value['Girl']['age']; ?>)
                                            </h4>
                                            ...
                                            <div class="ranking-list-image-wrap">
                                                <?php if (!empty($value['Image'][1]['Image']['imgId'])) { ?>
                                                    <img src="/userImgShop/Image/<?php echo $value['Image'][1]['Image']['imgId']; ?>/w300.jpg"
